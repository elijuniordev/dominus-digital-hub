...
// A inicialização local do Supabase que estava aqui foi REMOVIDA.
// Agora, usamos o 'supabaseServerClient' importado em todas as rotas.
...
router.get('/', async (req: Request, res: Response) => {
 try {
   // PASSO 2: Usar o cliente importado.
