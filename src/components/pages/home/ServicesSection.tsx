        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center justify-between gap-4">
                {!isLoading && services.length > 3 && (
                    <button onClick={scrollPrev} disabled={!prevBtnEnabled} className="p-3 rounded-full bg-card shadow-md transition-opacity hover:opacity-100 disabled:opacity-50">
                    ...
                    <div className="flex -ml-4">
                        {isLoading ? (
                            ...
                            services.map((service) => {
                                const ServiceIcon = iconMap[service.icon] || iconMap.Zap;
                                return (
                ...
                {!isLoading && services.length > 3 && (
                    <button onClick={scrollNext} disabled={!nextBtnEnabled} className="p-3 rounded-full bg-card shadow-md transition-opacity hover:opacity-100 disabled:opacity-50">
